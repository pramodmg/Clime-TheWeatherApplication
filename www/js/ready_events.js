...
(function($){
    ...
    window.menu = new native5.ui.SideMenu({'bodySelector':'.container_page','refresh':false, 'welcome':"<div><button type='button' class='btn btn-default navbar-btn clear_session btn_session'>Reset</button></div>"+"<div class='heading'>Locations <span class='fa fa-plus add_location' id='plus'></span></div>", 'displacement':'250'});
